...
START:
    ...
    lgdt [ GDTR +4 ]   ; GDTR �ڷᱸ���� ���μ����� �����Ͽ� GDT ���̺��� �ε�
    ...
    jmp dword 0x08: ( PROTECTEDMODE - $$ + 0x10000 + 0x4)
...
PROTECTEDMODE:
    ...
    ; ȭ�鿡 ��ȣ ���� ��ȯ�Ǿ��ٴ� �޽����� ��´�?.
    push ( SWITCHSUCCESSMESSAGE - $$ + 0x10004 )    ; �����? �޽����� ��巹����? ���ÿ� ����
    push 3                                          ; ȭ�� Y ��ǥ(2)�� ���ÿ� ����
    push 0                                          ; ȭ�� X ��ǥ(0)�� ���ÿ� ����
